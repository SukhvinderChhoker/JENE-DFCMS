...
public class Evidence {
    ...
    private LocalDate dateOfInduction;
    ...
    public LocalDate getDateOfInduction() { return dateOfInduction; }
    public void setDateOfInduction(LocalDate dateOfInduction) { this.dateOfInduction = dateOfInduction; }
