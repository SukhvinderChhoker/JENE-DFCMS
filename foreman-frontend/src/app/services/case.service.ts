...
export class CaseService {
  ...
  create(caseData: Partial<Case>, userId: number): Observable<Case> {
    return this.http.post<Case>(`${this.apiUrl}?userId=${userId}`, caseData);
  }
  ...
  authorize(id: number, auth: string, reason: string): Observable<any> {
    return this.http.put(`${this.apiUrl}/${id}/authorize`, { auth, reason });
  }
